...
Page({
  ...
  data: {
    list: [
      { title:'我的店铺列表', url: '/pages/my_shop/shop_list/index'},
      // { title:'套餐设置', url: '/pages/my_shop/combo_list/index'},
      { title:'我的收益', url: '/pages/my_investment/income/index?type=shop'},
      { title:'数据统计', url: '/pages/my_investment/statistics/index?type=shop'},
    ]
  },
